...
import com.keuin.rdiffbackup.RdiffBackup;
...
public final class PrintUtil {
    ...
    private static final Logger LOGGER = LogManager.getLogger(RdiffBackup.class);
    ...
    private static CommandContext<ServerCommandSource> message(CommandContext<ServerCommandSource> context, String messageText, boolean broadcastToOps, Style style) {
        Text text = Text.literal(Formatting.GOLD + "[RdiffBackup]" + Formatting.RESET + " ").append(Text.literal(messageText).setStyle(style));
        if (context != null) {
